	<div class="col-lg-12">
	  ...
	  <h3 class="bg-success"> <?php// update_users(); ?> </h3> 
...
<!--
		 ...
		 <div class="row">
			 ...
			 <div class="from-group">
				  ...
				  <textarea id="product-description" name="product_description" cols="50" rows="8" class="form-control"><?php //echo $product_description; ?></textarea>
			  </div>
			  
			  
			   <div class="from-group">
				  <label for="product-price">Product Price</label>
				  <input type="text" id="product-price" value="<?php// echo $product_price; ?>" name="product_price" class="form-control">
			   </div>
...
-->
           ...
           <input type="submit" id="" name="draft"value="Draft" class=" btn btn-warning">
           ...
           <div class="from-group">
			  ...
			  <div class="from-group">
				  ...
				  <input type="number" id="product-quantity" value="<?php //echo $product_quantity; ?>" name="product_quantity" class="form-control">
			   </div>
           
           <div class="from-group">
				  <label for="product-image">Select an Image</label>
				  <input type="file" id="product-image"  name="product_image" class="form-control">
				  <img src="../../resources/templates/uploads/<?php //echo $product_image; ?>" alt="">
			   </div>
